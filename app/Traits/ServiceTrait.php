...
use App\Component\room\src\services\cache\CacheRoomService;
...
trait ServiceTrait
{
    ...
    /**
     * @return CacheRoomService
     *
     * @throws BindingResolutionException
     */
    public function getCacheRoomService(): CacheRoomService
    {
        return app()->make(CacheRoomService::class);
    }
